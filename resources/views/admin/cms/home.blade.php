                                ...
                                <div class="card-body">
                                    @foreach ($page as $key => $value)
                                        <div class="row">
                                            ...
                                            <input type="hidden" name="data[{{$key}}][type]" value="home">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>{{ $value }} Title</label>
                                                    <input type="text" name="data[{{$key}}][title]" class="form-control"
                                                        placeholder="Enter Name" value="{{ !empty(pageData("home", $value)) ? pageData("home", $value)->title : ""}}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="data[{{$key}}][description]"
                                                        ...
                                                        {{ !empty(pageData("home", $value)) ? pageData("home", $value)->description : ""}}
                                                    </textarea>
                                                </div>
                                            </div>
                                        </div>
